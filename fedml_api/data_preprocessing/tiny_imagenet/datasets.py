...
class tiny(torchvision.datasets.VisionDataset):
    ...
    def __init__(
        ...
        # 当前文件的目录（比如 .../fedml_api/data_preprocessing/tiny_imagenet）
        _cur_dir = os.path.dirname(os.path.abspath(__file__))

        # 工程里的 data 路径（回退两级到项目根，再拼 data）
        root_dir = os.path.join(_cur_dir,
                                "../../../fedml_experiments/standalone/dfedpgp/data/tiny_imagenet/tiny-ImageNet-200")

        self.identity = os.path.join(root_dir, f"tiny{self.train}.pkl")
